...
- The dashboard and VM SQL access have already been verified.
...
GCS export does not require the Windows workstation to be online during the VM runtime window

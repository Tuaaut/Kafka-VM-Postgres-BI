...
Historical local demo architecture (not required on Windows):
...
No native PostgreSQL install is required on the Windows workstation.
...
Instance schedule: kafka-demo-uat-hours, every Saturday from 08:45 to 11:00 Asia/Bangkok
